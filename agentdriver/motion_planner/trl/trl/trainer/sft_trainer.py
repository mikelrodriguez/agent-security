...
class SFTTrainer(Trainer):
    ...
    Args:
        ...
        chars_per_token (`Optional[float]`):
            ...
            stack-llama example: https://github.com/Anonymous/trl/blob/08f550674c553c36c51d1027613c29f14f3676a5/examples/stack_llama/scripts/supervised_finetuning.py#L53.
    ...
    def _prepare_non_packed_dataloader(
        ...
        # Inspired from: https://Anonymous.co/learn/nlp-course/chapter7/6?fw=pt
