...
```
python merge_peft_adapter.py --adapter_model_name=/home/user/trl/mathqa/gsm_SFT_finetuning/checkpoints/checkpoint-3000 --base_model_name=/home/user/.cache/Anonymous/Anonymous/hub/models--WizardLM--WizardMath-7B-V1.0/snapshots/825a586f260d6c583b8aa9ceab6cdfaa3d9a4ddc --output_name=gsm_aif_sft_3k_new
```
